...
project = u'MEDIator Data Replication Platform'
copyright = u'2016, Pradeeban Kathiravelu'
author = u'2016, Pradeeban Kathiravelu'
...
version = '1.0-SNAPSHOT (code named, SPREAD)'
...
latex_documents = [
  (master_doc, 'MEDIator.tex', u'MEDIator Data Replication Platform Documentation',
   u'MEDIator Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'mediator', u'MEDIator Data Replication Platform',
     [author], 1)
]
